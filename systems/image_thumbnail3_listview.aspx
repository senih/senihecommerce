...
<script runat="server">
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If ConfigurationManager.AppSettings("UseSecureFileStorageForViewing") = "yes" Then
            sFile = ConfigurationManager.AppSettings("FileStorage") & "\file_views_listing\" & sFileLocation
        Else
            sFile = Server.MapPath("../resources") & "\internal\file_views_listing\" & sFileLocation
        End If
