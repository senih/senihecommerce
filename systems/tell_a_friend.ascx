...
<script runat="server">    
        ...
        Try
            ...
            For Each sItem In sToEmails.Split(";")
                ...
                sMessage.Body = GetLocalResourceObject("YourFriendOrColleague") & txtSenderName.Text & " (" & txtSenderEmail.Text & ")" & GetLocalResourceObject("ToughtThatYouWouldLike") & vbCrLf & vbCrLf _
                    & GetAppFullPath() & hidPage.Value & vbCrLf & vbCrLf _
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        oDataReader = oContentManager.GetPublishedContentById(Request.QueryString("id"))
        If oDataReader.Read() Then

            Dim nChannelPermission As Integer = oDataReader("channel_permission").ToString
            Dim sFileName As String = oDataReader("file_name").ToString
            If nChannelPermission = 1 Then
                lblPage.Text = oDataReader("title").ToString
                hidPage.Value = sFileName
            ElseIf nChannelPermission = 2 Then
                lblPage.Text = ""
                hidPage.Value = oDataReader("file_name").ToString
            Else
                lblPage.Text = ""
                hidPage.Value = ""
            End If
            lnkBack.NavigateUrl = "~/" & sFileName
        End If
        oDataReader.Close()
...
<tr>
    <td colspan="2" style="padding-top:14px">
        <asp:HyperLink ID="lnkBack" meta:resourcekey="lnkBack" runat="server">Back to Page</asp:HyperLink>
    </td>
</tr>
</table>
