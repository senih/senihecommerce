...
<script runat="server">
    ...
    Private Sub GetData()
        ...
        If sHTMLPagesWithin <> "" Then
            sPagesWithin = "<div class=""boxLinksWithin"">" & sHTMLPagesWithin & "<br /></div>"
        End If

        If nNumOfSameLevel > 1 Then
            sSameLevelPages = "<div class=""boxQuickLinks"">" & _
                "<div class=""boxHeaderQuickLinks"">" & sSameLevelPagesTitle & "</div>" & _
                "<ul style=""margin-top:2px;margin-left:10px;padding-left:10px"">" & _
                sHTMLSameLevelPages & "</ul>" & _
                "</div>"
        Else
            sSameLevelPages = ""
        End If
