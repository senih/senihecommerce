...
<script runat="server">
    ...
    Private sTopMenu As String = ""
    Private sBottomMenu As String = ""
    Private bDone As Boolean = False
    
    Public ReadOnly Property TopMenu() As String
        Get
            If Not bDone Then
                GetData()
                bDone = True
    ...
    Public ReadOnly Property BottomMenu() As String
        Get
            If Not bDone Then
                GetData()
                bDone = True
    ...
    Private Sub GetData()
        ...
        Dim sTopMenuLinkSeparator As String = " | "
        Dim sBottomMenuLinkSeparator As String = " | "
        ...
        If IO.File.Exists(sXmlPath) Then
            ...
            xmldoc.Load(fs)
            If Not IsNothing(xmldoc.SelectSingleNode("root/menu_top/separator")) Then
                sTopMenuLinkSeparator = xmldoc.SelectSingleNode("root/menu_top/separator").InnerText
            End If
            If Not IsNothing(xmldoc.SelectSingleNode("root/menu_bottom/separator")) Then
                sBottomMenuLinkSeparator = xmldoc.SelectSingleNode("root/menu_bottom/separator").InnerText
            End If
            xmldoc = Nothing
            fs = Nothing
        End If
        sTopMenuLinkSeparator = sTopMenuLinkSeparator.Replace(" ", "&nbsp;")
        sBottomMenuLinkSeparator = sBottomMenuLinkSeparator.Replace(" ", "&nbsp;")
        ...
        If Me.IsUserLoggedIn Then 'yus
            oCommand = New SqlCommand("advcms_ShowTopBottomMenu2")
        Else
            oCommand = New SqlCommand("advcms_ShowTopBottomMenu")
        End If
        ...
        Dim sHTMLTop As String = ""
        Dim sHTMLBottom As String = ""
        ...
        While oDataReader.Read()
            ...
            If bShowMenu Then
                If oDataReader("link_placement").ToString = "top" Then
                    If nPgId = Me.PageID Then
                        sHTMLTop += sTopMenuLinkSeparator & sTtl
                    Else
                        sHTMLTop += sTopMenuLinkSeparator & "<a " & sTarget & " href=""" & sFile & """ class=""topmenu"">" & sTtl & "</a>"
                    End If
                End If
                If oDataReader("link_placement").ToString = "bottom" Then
                    If nPgId = Me.PageID Then
                        sHTMLBottom += sBottomMenuLinkSeparator & sTtl
                    Else
                        sHTMLBottom += sBottomMenuLinkSeparator & "<a " & sTarget & " href=""" & sFile & """ class=""bottommenu"">" & sTtl & "</a>"
                    End If
                End If
            End If
        End While
        ...
        oContent = Nothing
        If sHTMLTop <> "" Then
            sTopMenu = "<span class=""topmenu"">" & sHTMLTop.Substring(sTopMenuLinkSeparator.Length) & "</span>"
        End If
        If sHTMLBottom <> "" Then
            sBottomMenu = "<span class=""bottommenu"">" & sHTMLBottom.Substring(sBottomMenuLinkSeparator.Length) & "</span>"
        End If
    End Sub
</script>
