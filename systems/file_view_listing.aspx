        ...
        If oDataReader.Read() Then
            ...
            If sFileName <> "" Then
                ...
                If ConfigurationManager.AppSettings("UseSecureFileStorageForViewing") = "yes" Then
                    sFile = ConfigurationManager.AppSettings("FileStorage") & "\file_views_listing\" & nPageId & "\" & sFileName
                Else
                    sFile = Server.MapPath("../resources") & "\internal\file_views_listing\" & nPageId & "\" & sFileName
                End If
