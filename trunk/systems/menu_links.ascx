...
<script runat="server">
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)      
        ...
        Dim sMainMenuLinkSeparator As String = "    "
        ...
        If IO.File.Exists(sXmlPath) Then
            ...
            xmldoc.Load(fs)
            If Not IsNothing(xmldoc.SelectSingleNode("root/menu_links/hide_root")) Then
                bHideHomeLink = CBool(xmldoc.SelectSingleNode("root/menu_links/hide_root").InnerText)
            End If
            If Not IsNothing(xmldoc.SelectSingleNode("root/menu_links/separator")) Then
                sMainMenuLinkSeparator = xmldoc.SelectSingleNode("root/menu_links/separator").InnerText
            End If
            xmldoc = Nothing
            fs = Nothing
        End If
            ...
            If bShowMenu Then
                If nPgId = Me.RootID Then
                    If Not bHideHomeLink Then 'Hide Home Link
                        sMenuLinks += sMainMenuLinkSeparator & "<a " & sTarget & " class=""mainmenu"" href=""" & sFile & """>" & sTtl & "</a>"
                    End If
                Else
                    sMenuLinks += sMainMenuLinkSeparator & "<a " & sTarget & " class=""mainmenu"" href=""" & sFile & """>" & sTtl & "</a>"
                End If
        ...
        If sMenuLinks <> "" Then
            panelMenu.Controls.Add(New LiteralControl("<div class=""mainbar"">" & sMenuLinks.Substring(sMainMenuLinkSeparator.Length) & "</div>"))
        End If
