...
<script runat="server">
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        litPlayer.Text = "<scr" & "ipt type=""text/javascript"" src=""" & sAppPath & "systems/media/swfobject.js""></scr" & "ipt>" & vbCrLf & _
            ...
            "var s3 = new SWFObject(""" & sAppPath & "systems/media/mp3player.swf"", ""playlist"", ""240"", ""135"", ""7"");" & vbCrLf & _
            ...
            "s3.addVariable(""height"",""135"");" & vbCrLf & _
            "s3.addVariable(""displayheight"",""0"");" & vbCrLf & _
